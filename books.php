...
while($row = mysqli_fetch_assoc($result)){
    $data[] = [
        ...
        "category" => $row['category'] ?? "Story Books"
    ];
}
?>
...
<head>
<meta charset="UTF-8">
<title>Books | ReadNova Book Store</title>
  ...
  <div class="topbar">
    <div>
      <button onclick="filterBooks('All')">Books</button>
        <button onclick="window.location.href='Novels.php'">Novels</button>
...
function filterBooks(cat){
  if(cat === "All") showBooks(books);
  else showBooks(books.filter(b => b.category === cat));
}
