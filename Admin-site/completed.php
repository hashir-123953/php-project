...
$count_query = "SELECT COUNT(*) as total_pending FROM orders WHERE status='competed '";
$count_result = mysqli_query($conn, $count_query);
$count_row = mysqli_fetch_assoc($count_result);
$total_pending = $count_row['total_pending'];

/* FETCH ONLY PENDING ORDERS */
$query = "SELECT * FROM orders WHERE status='competed ' ORDER BY id DESC";
...
<div class="main-content">
    <div class="container">
        <div class="page-box">
            ...
            <div class="total-box">
                Total Cancel Orders: <?php echo $total_pending; ?>
            </div>
